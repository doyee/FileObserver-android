...
public abstract class FileObserver {
    ...
    /** Event mask: changed event */
    public static final int CHANGES_ONLY = CREATE | DELETE | 
    ...
    public void startWatching() {
        if (mDescriptor < 0) {
            mDescriptor = s_observerThread.startWatching(mPath, mPath, mMask, this);
        }
    }
    ...
    public void stopWatching() {
        if (mDescriptor >= 0) {
            s_observerThread.stopWatching(mDescriptor, this);
            mDescriptor = -1;
        }
    }
